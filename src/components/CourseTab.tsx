...
const tabClassSelected = 'bg-lblue text-white px-4 py-1 rounded-t-2xl w-full border-navy border-x-3 border-t-3'
const tabClassNotSelected = 'bg-lgreen px-4 py-1 rounded-t-2xl w-full border-navy border-3'
